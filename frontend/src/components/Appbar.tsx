...
export const Appbar =()=>{
    ...
    return(<div className=" flex justify-between px-3 py-3  sm:px-20 border-b ">
        <div className=" flex gap-5 items-center">
            ...
            className="focus:ring-0  outline-none  block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50  " placeholder="Search" required />
