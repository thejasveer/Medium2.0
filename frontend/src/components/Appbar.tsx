...
export const Appbar =()=>{
    ...
    return(<div className=" flex justify-between px-5 py-3  sm:px-20 border-b ">
            ...
            {pathname==="/publish" && <div className="mx-2 font-light text-sm capitalize">Draft in {user?.username}</div> }
                ...
                <div className="grid grid-cols-2  items-center">
                        <div className="font-light px-2 col-span-1 ">
                            {pathname==="/publish" ?  <PublishButton text={"publish"} onclick={()=>{ setReviewToggle(true)}}/>
                                :       <Link to={"/publish"} className="flex gap-1 items-center text-light text-slate-400">
                        ...
                        {Object.keys(user).length > 0 ?   
                                    ...
                                    <Avatar  size={"size-8"} text={"text-xl"} name="sing" showlogout={true}/>
                                    </div>
                                    :
