    ...
    return(<div className=" flex justify-between px-3 py-3  sm:px-20 border-b ">
        <div className=" flex gap-5 items-center">
            ...
            { currDraftState!= ''   && <div className="mx-2 font-light text-sm capitalize"><span>{currDraftState}</span> </div> } 
                ...
                <div className="grid grid-cols-3 gap-1 lg:gap-3  items-center">
                        <div className="font-light px-2 col-span-2 ">
                        ...
                        { (authenticated) ?   
                                    ...
                                    :
                                    <div className="col-span-1 space-x-2 lg:space-x-4 text-slate-400">
